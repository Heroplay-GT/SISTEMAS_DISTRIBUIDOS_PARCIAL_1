...
/**
 * Adaptador de salida que implementa el puerto de salida de red (PuertoSalidaRed).
 * Responsabilidad única: Transformar objetos de dominio en datagramas UDP y transmitirlos
 * hacia el cliente a través del canal de red.
 */
