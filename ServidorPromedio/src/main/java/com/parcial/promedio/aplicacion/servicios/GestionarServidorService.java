...
/**
 * Servicio de aplicación que implementa el caso de uso de gestión del ciclo de vida del
 * servidor. Responsabilidad única: Coordinar el inicio y parada del servicio de red y
