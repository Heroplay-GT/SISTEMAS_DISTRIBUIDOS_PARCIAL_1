...
/**
 * Puerto de entrada (Caso de Uso) para el control del ciclo de vida del servidor UDP.
 * Invocado principalmente por el entrypoint de la interfaz de usuario (GUI).
 */
