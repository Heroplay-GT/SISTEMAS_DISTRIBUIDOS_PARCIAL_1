...
import com.parcial.promedio.dominio.enums.TipoRespuesta;
...
public final class RespuestaCliente {
    ...
    private RespuestaCliente(
        ...
        if (tipo == TipoRespuesta.OK_PROMEDIO && Objects.isNull(resultado)) {
    ...
    public static RespuestaCliente calculoExitoso(final Destinatario destinatario, final Resultado resultado) {
        return new RespuestaCliente(destinatario, TipoRespuesta.OK_PROMEDIO, resultado, null);
    }
