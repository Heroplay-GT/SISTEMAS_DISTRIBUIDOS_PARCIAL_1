...
import com.parcial.promedio.adaptadores.red.ObservadorServidor;
...
/**
 * Ventana principal de la interfaz gráfica del Servidor (Entrypoint GUI). Responsabilidad
 * única: Renderizar la interfaz visual, capturar acciones del usuario e interactuar
 * exclusivamente con los puertos de entrada y observadores de eventos.
 */
public class ServidorFrame extends JFrame implements ObservadorServidor {
    ...
    public ServidorFrame(final GestionarServidorInputPort gestionarServidorPort) {
        super("Servidor UDP - Promedio de 3 Notas (Arquitectura Hexagonal / SOLID)");
    ...
    private JPanel crearPanelNorte() {
        ...
        final JLabel lblTitulo = new JLabel("Servidor de Promedio de Notas (Protocolo UDP)");
